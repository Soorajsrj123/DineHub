          ...
          <div className="mt-12 grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
            {banners ? (
              ...
              >
                ...
                <button  onClick={() => handleDelete(banners._id)} class="inline-flex items-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm font-medium rounded-md">

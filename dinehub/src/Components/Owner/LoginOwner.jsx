...
import { LoginValidate } from "../../ToastError/ownerAuthToast";

import { OwnerLogin } from "../../helpers/ownerHelpers";
import { useDispatch } from "react-redux";
import { setOwner } from "../../Slices/ownerSlice";
  ...
  let formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      data
        ...
        .catch((err) => {
          console.log(err, "error in owner Loginpage");

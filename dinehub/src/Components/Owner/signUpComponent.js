...
import { signUpValidate } from "../../ToastError/ownerAuthToast";
import { OwnerSignUp } from "../../helpers/ownerHelpers";
import { useNavigate, useParams } from "react-router-dom";

import {getRestaurantsRequest as getRestaurantDetails } from '../../helpers/adminHelpers' 
...
const [email,setEmail]=useState('')
  ...
  useEffect(()=>{
    ...
    onSubmit: async (values) => {
      const Id={id:id}
      const allDatas=Object.assign({},values,Id)
      // console.log(values,id,"here values and id");
      try {
        let res =  OwnerSignUp(allDatas)
            ...
            <div className="w-full space-y-6 text-gray-600 sm:max-w-md">
                ...
                <Toaster position='top-center' reverseOrder={false}></Toaster>
                    ...
                    <div className="mt-5 space-y-2">
                        ...
                        <p className="">Alreay have an account? <a href="/owner/login" className="font-medium text-indigo-600 hover:text-indigo-500">Login</a></p>
                    </div>
                </div>

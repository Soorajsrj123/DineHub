                  ...
                  <div className="bg-white shadow-lg rounded-lg -mt-4 w-64">
                    <div className="py-5 px-5">
                      <span className="font-bold text-gray-800 text-lg">
                       ...
                       {dish.classification==="non-veg"? <img className="w-5" src={nonVegImg} alt="veg" />
          ...
          {dishDatas.map((dish) => {
            ...
            return (
              <div key={dish._id} className="flex items-center justify-between mt-5 ">
                {dish.count ? (
                  <div>
                    <p className="text-xl text-gray-500">{dish.dishName.toUpperCase()}</p>
                    <p className="text-base text-black-400">QTY:{dish.count}</p>

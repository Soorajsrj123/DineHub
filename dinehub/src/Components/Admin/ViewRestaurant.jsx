          ...
          <div class="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex flex-col mt-5 ">
                ...
                <h2 class="text-sm leading-relaxed title-font pt-4 text-gray-500 tracking-widest">
                  {record?.address?.place_name}
                </h2>
              </div>
              <div class="flex mt-8 items-center  pb-5 border-b-2 border-gray-100 mb-5">
                <div class="flex">
                  <span class="mr-3 mt-3 font-serif ">Facilites</span>
                  {record?.wifi ? <FcWiFiLogo size={40} /> : ""}
                  {/* <button class="border-2 border-gray-300 rounded-full w-6 h-6 focus:outline-none"></button> */}
                  {record?.parking ? (
                    <FaParking className="ml-7 " color="green" size={40} />
                  ) : (
                    ""
                  )}
                  ...
                  {record?.aircondition ? (
                    <img
                      src={Ac}
                      alt="kk"
                      className="border-2 border-gray-300  rounded w-9 h-9 ml-6 focus:outline-none"
                    />
                  ) : (
                    ""
                  )}
            ...
            <div class="relative">
              ...
              <div className="flex my-4 ">
                <h2 class="text-sm title-font font-serif text-green-500 tracking-widest ">
                  OPEN:{record?.startTime}
                </h2>
              </div>
              <div className="flex">
                <h2 class="text-sm title-font font-serif text-red-500 tracking-widest">
                  CLOSE: {record?.endTime}
                </h2>
              </div>

    ...
    <div className="App">
      <BrowserRouter>
        <Routes>
          ...
          <Route
            path="/restaurant/list-dishes/:id"
            element={<DishListsPage />}
          />
          ...
          />
          <Route
            path="/admin/restaurant/declined-list"
            element={<DeclinedRequestList />}
          />
          ...
          <Route
            path="/admin/restaurant/view-restaurant/:id"
          ...
          <Route
            path="/owner/registration-success"
            element={<RegistrationSuccessComponent />}
          />
          <Route path="/owner/signup-otp" element={<OwnerOtpComponent />} />
          <Route
            path="/owner/forgot-pass/otp"
            element={<OwnerForgotPassOtpPage />}
          />
          <Route path="/owner/new-password/:id" element={<OwnerForgotPass />} />
          <Route path="/owner/banner" element={<BannerPage />} />
          <Route
            path="/owner/add-restaurant-banner"
